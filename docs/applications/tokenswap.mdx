...
| OpenContract | Public receipt fields (aggregated via checkpoints below), attestation reference, cumulative checkpoints, and final root | Contract state and settlement commitment |
