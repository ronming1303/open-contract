...
| Key / credential | Type | Purpose | Custody |
|---|---|---|---|
| Identity key | Long-term, the Seller's existing Ethereum key | Signs the API Key challenge, x402 calls, and (future) an endorsement binding a specific TEE instance's public key to the ticket | Never leaves the Seller |
