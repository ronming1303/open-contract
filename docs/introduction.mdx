...
<CardGroup cols={2}>
  ...
  <Card title="TokenSwap" icon="arrows-rotate" href="/core-concepts/tokenswap">
    The first OpenContract service-matching application: verifiable, time-bounded AI inference capacity coordinated through usage tickets and TEE receipts.
  </Card>
</CardGroup>
