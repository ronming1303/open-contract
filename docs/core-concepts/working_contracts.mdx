...
| Delivers on time, `fully met` or `partially met` | Returned in full | Settled per [delivery quality](#contract-lifecycle) — payment, not stake, reflects quality |
