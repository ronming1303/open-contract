...
sequenceDiagram
    ...
    alt Award Method: Open Tender — BA drawn from bidder pool
        alt Verification Mode: Standard (default)
            OC<<->>BA: Consensus vote (fully met / partially met / none met)
            OC->>BA: Token reward
            ...
            opt Disputed, before Review Deadline
                ...
                OC<<->>BA: Decrypted consensus vote (fully met / partially met / none met)
                OC->>BA: Token reward
            end
        end
        ...
        alt Verification Mode: Privacy-Preserving (default)
            ...
            opt Disputed, before Review Deadline
                Client->>OC: Stake dispute bond
                Note right of OC: ● Status → disputed
                OC<<->>BA: Recruit & decrypted consensus vote (fully met / partially met / none met)
                OC->>BA: Token reward
            end
        else Verification Mode: Standard
            OC<<->>BA: Recruit & consensus vote (fully met / partially met / none met)
            OC->>BA: Token reward
        end
    end
